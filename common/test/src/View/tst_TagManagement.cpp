...
private:
  ...
  {
    auto textureA =
      Assets::Texture{"some_texture", makeResource(Assets::TextureImage{16, 16})};
    auto textureB =
      Assets::Texture{"other_texture", makeResource(Assets::TextureImage{32, 32})};
    auto textureC =
      Assets::Texture{"yet_another_texture", makeResource(Assets::TextureImage{64, 64})};
